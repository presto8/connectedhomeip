...
class TestZapFileParser(unittest.TestCase):
  ...
  def test_generate_hash(self):
    ...
    self.assertEqual(hash_string, "Qjpioco3A8", "Hash is incorrectly generated.")
  ...
  def test_generate_name(self):
    ...
    self.assertEqual(name, "rootnode_dimmablelight_Qjpioco3A8", "Name incorrectly generated.")
